...
const createSchema = z.union([valueSnapshotSchema, stockTradeSchema, stockSnapshotSchema]);
...
export async function POST(
  ...
  try {
    ...
    const record = await repository.createAssetRecord(id, normalizeRecordInput(body));
